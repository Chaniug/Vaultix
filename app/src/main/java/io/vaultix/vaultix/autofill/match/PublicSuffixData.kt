/*
 * Vaultix — app:autofill · match · 自动生成数据文件
 * Copyright (C) 2026 Vaultix contributors
 *
 * 由公共后缀列表（https://publicsuffix.org/list/public_suffix_list.dat）生成，Mozilla 许可证。
 * 请勿手改。因单条字符串常量受 JVM 64KB 上限约束，按类别分块存储后运行时拼接。
 * 规则三类：EXACT（精确后缀）/ WILDCARD（*. 前缀去 *）/ EXCEPTION（! 前缀去 !）。
 */
@file:Suppress("LargeClass", "MayBeConstant")
package io.vaultix.vaultix.autofill.match

internal object PublicSuffixData {
    internal const val PSL_EXACT_1 = """
ac
com.ac
edu.ac
gov.ac
...
hayakawa.ya
"""
    internal const val PSL_EXACT_2 = """
manashi.jp
hokuto.yamanashi.jp
...
mra
"""
    internal const val PSL_EXACT_3 = """
p.accesspoint.s3-global.amazonaws.com
s3-me-south-1.amazonaws.com
...
v0.buil
"""
    internal const val PSL_EXACT_4 = """
d
vercel.dev
vusercontent.net
tmp.now
...
zabc.net
"""
    internal val PSL_EXACT: String = PSL_EXACT_1 + PSL_EXACT_2 + PSL_EXACT_3 + PSL_EXACT_4
    internal const val PSL_WILDCARD_1 = """
nom.br
ck
er
fk
...
zerops.zone
"""
    internal val PSL_WILDCARD: String = PSL_WILDCARD_1
    internal const val PSL_EXCEPTION_1 = """
www.ck
city.kawasaki.jp
city.kitakyushu.jp
city.kobe.jp
...
city.yokohama.jp
"""
    internal val PSL_EXCEPTION: String = PSL_EXCEPTION_1
}
