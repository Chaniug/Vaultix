...
> 索引：[`../ISSUES.md`](../ISSUES.md)（编号 → 分篇）· 共 **10** 条：#59、#64、#69、#93、#94、#95、#96、#98、#99、#106
>
> ⚠️ 2026-09-26 校正：原写 3 条、列 3 个号 —— **错得最多的一篇**（实际 10 条）。
> 漏掉的 #93–#99、#106 全是 KDBX 读写路径排查新增的，题注从未跟上。
> （注：常见误引 `#83`「KDBX 相关」其实**全仓无正文条目**，别把它算进本篇。）
